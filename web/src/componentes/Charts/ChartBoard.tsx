...
import { SwitchInput } from "../Form/InputTypes";

// const NavButtons: any = ({ controlersIds }: any) => {
    ...
    return (
        <div className="grid grid-cols-2 gap-y-5 w-[95%] mx-auto my-8 p-4 bg-slate-200 rounded">
            <div className="grid grid-cols-subgrid col-span-2 gap-5 ">
                ...
                <SwitchInput extendedStyle="justify-self-center w-32 py-1" onSwitchCheck={() => { handleButtonClick('') }}>Charts</SwitchInput>

                <SwitchInput extendedStyle="justify-self-center w-32 py-1">Charts</SwitchInput>
