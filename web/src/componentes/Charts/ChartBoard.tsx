    ...
    return (
        <div className="grid grid-cols-2 gap-y-5 w-[95%] mx-auto my-8 p-4 bg-slate-200 rounded">
            <div className="grid grid-cols-subgrid col-span-2 gap-5 ">
                <ToggleSwitch SwitchLabel="Charts" SwitchName="toggle-charts" ToggleFunction={() => { ToggleTargetComponent(showInsights, setShowInsights) }} />
            ...
            {(
                <div className={`grid grid-cols-subgrid col-span-2 gap-7 justify-center content-center`}>
                    ...
                    {/* <div className={` col-span-2 justify-self-center ${showInsights || 'hidden'}`}>
                        {transferChart && <CpuChart />}
                    </div> */}
                    {!showInsights &&
